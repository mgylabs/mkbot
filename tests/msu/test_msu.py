...
class MSUTest(TestCase):
    ...
    def setUpClass(cls):
        cls.patcher_get = patch('src.msu.msu.requests.get',
                                side_effect=cls.generate_mock_requests_get('1.3.3', '1.4.0', '82980060b4606ef9bc428932736647d45e400fd9'))
    ...
    def test_Updater_init(self, mock_get):
        ...
        updater = msu.Updater(current_version, False)
        stable_expected = {'commit': None, 'url': 'https://github.com/mgylabs/mulgyeol-mkbot/releases/download/v1.4.0/MKBotSetup-1.4.0.zip',
                           'rtype': 'stable', 'version': version.parse('1.4.0'), 'sha': '16bb694a133c33fe80c4b67be2a3e000facd883c'}
